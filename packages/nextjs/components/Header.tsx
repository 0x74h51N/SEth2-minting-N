...
export const Header = () => {
  ...
  const navLinks = (
    <>
      <li>
        <NavLink href="/NNNtab">NNN</NavLink>
      </li>
      <li>
        <NavLink href="/NVMtab">NVM</NavLink>
      </li>
      <li>
        <NavLink href="/debug">
      ...
      <div className="navbar-start w-auto lg:w-1/2">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6">
          ...
          <div className="flex flex-col">
            <span className="font-bold leading-tight">Novem Tokens</span>
            <span className="text-xs">Token minting and burning</span>
          </div>
        </Link>
